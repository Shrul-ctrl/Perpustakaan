...
class PenulisController extends Controller
{
    public function index()
    {
        ...
        $user = Auth::user();
        return view('Role.staff.penulis.index', compact('user', 'peminjamannotif', 'penulis', 'jumlahpengajuan', 'jumlahpengembalian'));
    }
    ...
    public function create()
    {
        ...
        $peminjamannotif = Peminjamens::all();
        $user = Auth::user();
        return view('Role.staff.penulis.create', compact('peminjamannotif', 'user', 'jumlahpengajuan', 'jumlahpengembalian'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.penulis.index')->with('success', 'Data berhasil ditambah');
    }

    public function show(Penuli $penuli)
    {
        $user = Auth::user();
        return view('Role.staff.penulis.show', ['user' => $user], compact('penuli'));
    }
    ...
    public function edit(Penuli $penuli)
    {
        ...
        $jumlahpengembalian = Peminjamens::where('status_pengajuan', 'dikembalikan')->where('notif', false)->count();
        $jumlahpengajuan = Peminjamens::where('status_pengajuan', 'menunggu pengajuan')->where('notif', false)->count();
        return view('Role.staff.penulis.edit', compact('peminjamannotif', 'user', 'penuli', 'jumlahpengajuan', 'jumlahpengembalian'));
    }
    ...
    public function update(Request $request, Penuli $penuli)
    {
        ...
        $penuli->nama_penulis = $request->nama_penulis;
        $penuli->save();
        return redirect()->route('staff.penulis.index')->with('success', 'Data berhasil diubah');
    }
    ...
    public function destroy($id)
    {
        ...
        $penuli->delete();
        return redirect()->route('staff.penulis.index')->with('success', 'Data berhasil dihapus');
    }
}