...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $user = Auth::user();
        return view('Role.admin.user.index', compact('peminjamannotif','user','users','jumlahpengajuan','jumlahpengembalian'));
    }
    ...
    public function create()
    {
        ...
        $peminjamannotif = Peminjamens::all();
        $user = Auth::user();
        return view('Role.admin.user.create', compact('peminjamannotif','user','jumlahpengajuan','jumlahpengembalian'));
    }
    ...
    public function show(User $user)
    {
        ...
        $jumlahpengajuan = Peminjamens::where('status_pengajuan','menunggu pengajuan')->where('notif', false)->count();
        $peminjamannotif = Peminjamens::all();
        return view('Role.admin.user.show', compact('peminjamannotif','user','jumlahpengajuan','jumlahpengembalian'));
    }
    ...
    public function edit(User $user)
    {
        ...
        $jumlahpengajuan = Peminjamens::where('status_pengajuan','menunggu pengajuan')->where('notif', false)->count();
        $peminjamannotif = Peminjamens::all();
        return view('Role.admin.user.edit', compact('peminjamannotif','user','jumlahpengajuan','jumlahpengembalian'));
    }
