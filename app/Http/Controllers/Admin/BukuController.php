...
class BukuController extends Controller
{
    ...
    public function index()
    {
        ...
        $bukus = Buku::all();
        $user = Auth::user();
        return view('Role.admin.buku.index', compact('peminjamannotif', 'user', 'buku', 'bukus', 'jumlahpengajuan', 'jumlahpengembalian'));
    }
    ...
    public function create()
    {
        ...
        $user = Auth::user();
        return view('Role.admin.buku.create', compact('peminjamannotif', 'user', 'jumlahpengajuan', 'jumlahpengembalian', 'kategori', 'penulis', 'penerbit'));
    }
    ...
    public function show($id)
    {
        ...
        $user = Auth::user();
        return view('Role.admin.buku.show', compact('peminjamannotif', 'buku', 'jumlahpengajuan', 'jumlahpengembalian', 'user'));
    }
    ...
    public function edit(buku $buku)
    {
        ...
        $kategori = kategori::all();
        $user = Auth::user();
        return view('Role.admin.buku.edit', compact('peminjamannotif', 'user', 'jumlahpengajuan', 'jumlahpengembalian', 'kategori', 'penulis', 'penerbit', 'buku'));
    }
