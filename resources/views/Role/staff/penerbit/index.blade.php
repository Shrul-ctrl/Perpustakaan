...
<div class="col-4 col-xl-4">
    <div class="card">
        <div class="card-body p-4">
            ...
            <form class="row g-3" method="POST" action="{{ route('staff.penerbit.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        <a href="{{route('staff.penerbit.index')}}" class="btn btn-danger px-4 btn-sm">Batal</a>
                        {{-- <a href="{{route('staff.penerbit.create')}}" class="btn btn-grd btn-primary px-4 ">Reset</a> --}}
...
<div class="col-8 col-xl-8">
    <div class="card">
        <div class="card-body">
            ...
            @endif
            {{-- <a href="{{ route('staff.penerbit.create') }}" class="btn btn-grd btn-primary px-5 mb-2">Tambah Data <i class="material-icons-outlined" style="font-size: 18px; vertical-align: middle;">add</i></a> --}}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('staff.penerbit.destroy', $data->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('staff.penerbit.edit', $data->id) }}" class="btn btn-warning text-light btn-sm" data-bs-toggle="tooltip" data-bs-placement="left" title="Edit Data"> <i class="material-icons-outlined" style="font-size: 18px;">edit</i></a>
