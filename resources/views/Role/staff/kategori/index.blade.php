...
@section('content')
<h3 class="mb-0 text-uppercase pb-3">TABEL KATEGafORI</h3>
<hr>
...
<div class="col-4 col-xl-4">
    <div class="card">
        <div class="card-body p-4">
            ...
            <form class="row g-3" method="POST" action="{{ route('staff.kategori.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        <a href="{{route('staff.kategori.index')}}" class="btn btn-danger px-4 btn-sm">Batal</a>
                        {{-- <a href="{{route('staff.kategori.create')}}" class="btn btn-grd btn-primary px-4 ">Reset</a> --}}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('staff.kategori.destroy', $data->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('staff.kategori.edit', $data->id) }}" class="btn btn-warning text-light btn-sm" data-bs-toggle="tooltip" data-bs-placement="left" title="Edit Data"> <i class="material-icons-outlined" style="font-size: 18px;">edit</i></a>
