...
<div class="col-12 col-xl-12">
    <div class="card">
        <div class="card-body p-4">
            ...
            <form class="row g-3" method="POST" action="{{ route('staff.user.store') }}">
                @csrf
                @if ($errors->has('email'))
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        <a href="{{route('staff.user.index')}}" class="btn btn-danger px-4">Batal</a>
                        {{-- <a href="{{route('staff.user.create')}}" class="btn btn-grd btn-primary px-4 ">Reset</a> --}}
