...
@section('content')
<form class="row g-3" enctype="multipart/form-data" action="{{ route('staff.peminjaman.update', $peminjaman->id) }}" method="POST">
    @csrf
    @method('PATCH')
    <div class="col-md-6">
    ...
    <div class="col-md-12">
        <div class="d-md-flex d-grid align-items-center gap-3">
            <input type="hidden" name="redirect_to" value="staff.showpengajuan">
