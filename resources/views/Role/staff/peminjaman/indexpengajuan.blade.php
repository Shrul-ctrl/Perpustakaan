                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" style=" vertical-align: middle;">
                            <a href="{{ route('staff.showpengajuan' , $data->id) }}"  class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="left" title="Lihat detail"><i class="material-icons-outlined pt-1" style="font-size: 18px;">visibility</i></a>                         
                        </td>
                    </tr>
                    @endforeach
                </tbody>
