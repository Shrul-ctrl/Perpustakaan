...
<div class="card">
    <div class="card-body">
        ...
        {{-- <div class="d-flex mb-3"> --}}
            {{-- <a href="{{ route('staff.peminjaman.create') }}" class="btn btn-grd btn-primary px-5">Tambah Data <i class="material-icons-outlined" style="font-size: 18px; vertical-align: middle;">add</i></a> --}}
        {{-- </div> --}}
