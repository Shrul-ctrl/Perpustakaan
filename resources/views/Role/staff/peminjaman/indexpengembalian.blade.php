...
<div class="card">
    <div class="card-body">
        ...
        @endif
        {{-- <a href="{{ route('staff.peminjaman.create') }}" class="btn btn-grd btn-primary px-5 mb-2">Tambah Data Peminjaman</a> --}}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" style=" vertical-align: middle;">
                            <a href="{{ route('staff.showpengembalian' , $data->id) }}" class="btn btn-primary btn-sm"  data-bs-toggle="tooltip" data-bs-placement="left" title="Lihat detail"><i class="material-icons-outlined pt-1" style="font-size: 18px;">visibility</i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
