...
<p class="dash-lable mb-0 bg-primary bg-opacity-10 text-primary rounded-2 d-flex">Menunggu Persetujuan <br> Peminjaman</p>
...
<p class="dash-lable mb-0 bg-warning bg-opacity-10 text-warning rounded-2">Menunggu Persetujuan <br> Dikembalikan</p>
